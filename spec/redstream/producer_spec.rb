...
RSpec.describe Redstream::Producer do
  ...
  it "should delay messages for individual objects" do
    ...
    expect { producer.delay(product) }.to change { redis.xlen(Redstream.stream_key_name("products-delay")) }.by(1)
  ...
  it "should bulk delay messages for scopes" do
    ...
    expect { producer.bulk_delay(Product.all) }.to change { redis.xlen(Redstream.stream_key_name("products-delay")) }.by(2)
