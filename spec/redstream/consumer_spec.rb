...
RSpec.describe Redstream::Consumer do
  it "should be mutually exclusive" do
    ...
    threads = Array.new(2) do |i|
      Thread.new do
        Redstream::Consumer.new(stream_name: "products", batch_size: 5).run_once do |batch|
          calls.increment
  ...
  it "should use an existing offset" do
    ...
    consumer = Redstream::Consumer.new(stream_name: "products")
  ...
  it "should yield messages in batches" do
    ...
    consumer = Redstream::Consumer.new(stream_name: "products", batch_size: 10)
  ...
  it "should update the offset" do
    ...
    Redstream::Consumer.new(stream_name: "products").run_once {}
